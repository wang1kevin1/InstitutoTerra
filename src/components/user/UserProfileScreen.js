...
export default class UserProfileScreen extends React.Component {
    ...
    constructor(props) {
        ...
        this.slides = [
            { image: require('../../assets/background/profile/bg_trees.png'), title: 'árvores plantadas' },
            { image: require('../../assets/background/profile/bg_carbon.png'), title: 'toneladas de carbono compensado' }
        ]
    }
    ...
    _renderItem = ({ item, index }) => {
        return (
            <ImageBackground style={styles.ImageBackground} source={this.slides[index].image}>
